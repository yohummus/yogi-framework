...
_YOGI_WEAK_SYMBOL int (*YOGI_BranchGetConnectedBranches)(void* branch, const char** json, int* jsonsize) =
    Library::get_function_address<int (*)(void* branch, const char** json, int* jsonsize)>(
        "YOGI_BranchGetConnectedBranches");
