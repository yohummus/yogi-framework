...
public static partial class Yogi
{
    ...
    {
        // :BEGIN_CODEGEN: gen_dotnet_enums
    ...
    public enum HttpMethods
    {
        ...
        /// <summary>HEAD method for retrieving the same header as with the GET request but without the response body..</summary>
        Head = 1 << 1,
    ...
    public enum ConfigurationFlags
    {
        ...
        /// <summary>Makes configuration options given directly on the command line overridable.</summary>
        MutableCmdLine = 1 << 1,
    ...
    public enum CommandLineOptions
    {
        ...
        /// <summary>At one configuration file must be given.</summary>
        FilesRequired = 1 << 13,

        /// <summary>Include the --override switch for overriding arbitrary configuration sections.</summary>
        Overrides = 1 << 14,
    ...
    public enum BranchEvents
    {
        ...
        /// <summary>Querying a new branch for information finished (successfully or not).</summary>
        BranchQueried = 1 << 1,

        /// <summary>Connecting to a branch finished (successfully or not).</summary>
        ConnectFinished = 1 << 2,
